                            ...
                            <div id="example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                                <form action="<?php echo e(route('update-profile')); ?>" method="POST" class="form"
                                    ...
                                    <?php if(!empty($update_user_profile)): ?>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <?php if(!empty($update_user_profile->get_userprofile->profile_image ?? '')): ?>
                                                    <div class="profile">
                                                        <img src="<?php echo e(url('public/profiles/' . $update_user_profile->get_userprofile->profile_image ?? '')); ?>"
                                                            id="output" alt="">
                                                    </div>
                                                <?php else: ?>
                                                    <div class="profile">
