                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                @if ($update_user_profile->industry_id == null)
                                                    <input type="text" name="industry_name" value="{{ $update_user_profile->business_name }}">
                                                @else
                                                    <select name="industry_id" id="industry_id" class="form-control" onchange="check(this);">
                                                        <option value="" {{ $update_user_profile->industry_id ? '' : 'selected' }}>
                                                            Select Business Name
                                                        </option>
                                                        @foreach ($industries as $value)
                                                            <option value="{{ $value->id }}" {{ $update_user_profile->industry_id == $value->id ? 'selected' : '' }}>
                                                                {{ $value->industry_type ?? 'Unknown Industry' }}
                                                            </option>
                                                        @endforeach
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="uploadFile" type="file"
                                                    placeholder="Enter Business Information" data-bs-original-title=""
                                                    title="" name="business_license_copy">
                                                    <input type="hidden" name="old_business_license_copy_image" value="{{$users->business_license_copy}}">
