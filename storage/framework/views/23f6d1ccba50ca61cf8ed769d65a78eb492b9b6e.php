                    ...
                    <div class="card-body">
                        <div class="form theme-form">
                            <form id="" action="<?php echo e(route('user-update', $users->id)); ?>" method="POST"
                                ...
                                <input type="hidden" name="old_image" value="<?php echo e($users->profile_image); ?>">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <?php if($update_user_profile->industry_id == null): ?>
                                                    <input type="text" name="industry_name" value="<?php echo e($update_user_profile->business_name); ?>">
                                                <?php else: ?>
                                                    <select name="industry_id" id="industry_id" class="form-control" onchange="check(this);">
                                                        <option value="" <?php echo e($update_user_profile->industry_id ? '' : 'selected'); ?>>
                                                        ...
                                                        <?php $__currentLoopData = $industries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($value->id); ?>" <?php echo e($update_user_profile->industry_id == $value->id ? 'selected' : ''); ?>>
                                                                <?php echo e($value->industry_type ?? 'Unknown Industry'); ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="uploadFile" type="file"
                                                    placeholder="Enter Business Information" data-bs-original-title=""
                                                    title="" name="business_license_copy">
                                                    <input type="hidden" name="old_business_license_copy_image" value="<?php echo e($users->business_license_copy); ?>">
...
<?php echo $__env->make('admin_dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tuo1yqxe1xkd/public_html/live_project/project.conceptionmasters.com/next_client_dev/v1/resources/views/admin_dashboard/users/edit.blade.php ENDPATH**/ ?>