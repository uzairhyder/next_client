            ...
            <div class="col-lg-9">
                ...
                <form class="contactForm" id="contactform" method="POST">
                    ...
                    <div class="mb-3 col-lg-7 wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                        <input type="text" placeholder="Full Name" name="name" class="text-light" value="<?php echo e(old('name')); ?>">
                    </div>
                    ...
                    <div class="mb-3 col-lg-7 wow animated fadeInLeft">
                        <input type="tel" id="phone12" placeholder="Contact No." name="contact" class="text-light" value="<?php echo e(old('contact')); ?>">

                    </div>

                    <div class="mb-3 col-lg-7 wow animated fadeInRight">
                        <textarea type="message" name="message" id="" name="message" cols="85" rows="7" placeholder="Message" class="text-light"><?php echo e(old('message')); ?></textarea>
                    </div>
