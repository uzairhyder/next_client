        ...
        <div class="container mt-5 pt-5">
            ...
            <div class="col-lg-12 mb-3 mt-4 text-center">
                <a href="<?php echo e(route('customer-search')); ?>"><button type="button" class="Btn wow animated bounceIn"
                        ...
                        <br>
                    <?php if(!Auth::check()): ?>
                    <h6 style="color: #c00303">Please Login to View Details</h6>
                    <?php endif; ?>
            </div>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tuo1yqxe1xkd/public_html/live_project/project.conceptionmasters.com/next_client_dev/v1/resources/views/frontend/only-api-random-search-results.blade.php ENDPATH**/ ?>