                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" type="file" placeholder="Enter  Page Name" data-bs-original-title="" title="" name="banner_image"  >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col">
                                    <div>
                                        ...
                                        <a class="btn btn-danger" href="{{route('banner.index')}}" data-bs-original-title="" title="">Cancel</a>
                                    </div>
                                </div>
                            </div>
