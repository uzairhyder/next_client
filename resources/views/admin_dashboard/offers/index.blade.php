                ...
                <div class="card">
                    <div class="card-header">
                        {{-- <div class="col-xl-12 p-0 left-btn"><a class="btn btn-gradient" data-bs-original-title="" title=""
                                href="{{ route('offers.create') }}">Create</a></div> --}}

                        <h5>Offers Images List </h5>
                    </div>
                    <div class="card-body">
                                ...
                                <table class="display dataTable no-footer" id="basic-1" role="grid"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="basic-1"
                                                aria-label="Details: activate to sort column ascending">Background Image</th>
                                            <th class="sorting" tabindex="0" aria-controls="basic-1"
                                        ...
                                        @foreach ($offers as $value)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('offers.edit', $value->id) }}"> <button
