                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        {{-- <div class=""><a class="btn btn-gradient" data-bs-original-title="" title=""
                                href="{{ route('brand.create') }}">Add</a></div> --}}
                                    ...
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting_asc" tabindex="0" aria-controls="basic-1" rowspan="1"
                                                ...
                                                aria-label="Details: activate to sort column ascending">Parent Category Name</th>
                                                <th class="sorting" tabindex="0" aria-controls="basic-1"
                                                aria-label="Details: activate to sort column ascending">Sub Category Name</th>
                                            <th class="sorting" tabindex="0" aria-controls="basic-1"
                                                aria-label="Details: activate to sort column ascending">Brand</th>
                                                <th class="sorting" tabindex="0" aria-controls="basic-1"
                                    ...
                                    <tbody>
                                        @foreach ($brands as $value)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    <a href="{{ route('brand-status', $value->id) }}">
                                                        @if ($value->status == 1)
                                                ...
                                                <td>
                                                    <a href="javascript:void(0);" class="deletebrand"
                                                        data-id="{{ $value->id }}">
                                                        <button class="btn btn-danger btn-xs" type="submit"
                                                            data-original-title="btn btn-danger btn-xs">Delete</button></a>

                                                    <a href="{{ route('brand.edit', $value->id) }}"> <button
