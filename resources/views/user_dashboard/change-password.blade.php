                ...
                <div class="row">
                    <div class="col-lg-12">
                        <form id="newpassword" action="" class="form1">
                            ...
                            {{-- <div class="col-lg-9 mt-4 d-flex align-items-center position-relative for-right-decrease">
                                <input id="password3" type="password" class="form-control eyeDiv" name="confirm_password" placeholder="Confirm Password">
                                <i class="fa fa-eye eyeicon" aria-hidden="true" id="eye3"></i>
                            </div> --}}
                            <div class="col-lg-9">
                                <div class="mb-4 mt-4">
