                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class=""><a class="btn btn-gradient" data-bs-original-title="" title=""
                                href="{{ route('social.index') }}">Back</a></div>
                    </div>
                    <div class="card-body">
                        <div class="form theme-form">
                            <form id="" action="{{ route('social.update', $socials->id) }}" method="POST">
                                ...
                                @csrf
                                @method('PUT')
                                <input type="hidden" name="social_id" value="{{ $socials->id }}">
                                {{-- <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label>Twitter</label>
                                            <input class="form-control" type="text" placeholder="Enter Your Question"
                                                data-bs-original-title="" title="" name="twitter"
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" type="text" placeholder="Enter Your Question"
                                                data-bs-original-title="" title="" name="instagram"
