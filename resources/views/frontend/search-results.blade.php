            ...
            <form action="" class="form">
                <div class="row d-flex justify-content-center align-items-center">
                    ...
                    {{-- <div class="row sectionCstm">
                        ...
                        <form action="{{ route('search-customers') }}" method="post">
                            @csrf
                            ...
                            <div class="col-lg-12 mb-3 mt-4 text-center">
                                ...
                                <button type="submit" class="Btn wow animated bounceIn"
                                        data-wow-duration="1s" data-wow-delay="0.5s">Search test
                                        Now</button>
                            </div>
                        </form>
                    </div> --}}
                                    ...
                                    <div class="circleDivImg">
                                        ...
                                        @elseif (Auth::check() && !empty($points) && $points > 0 && $customer_points->end_date > Carbon\Carbon::now())
                                            <div>
                                                ...
                                                {{-- <p>{{ Str::limit($value->address, 19) ?? '' }}</p>
                                                <p class="mt-2"><a href="tel:{{ $value->contact ?? '' }}">{{ $value->contact ?? '' }}</a>
                                                </p>
                                                <p>
