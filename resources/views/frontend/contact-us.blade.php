        ...
        <div class="row d-flex justify-content-center align-items-center">
            ...
            <form class="contForm" id="contactform">
                ...
                <div class="mb-3 col-lg-7 wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                    <input type="text" placeholder="Name" name="name" class="text-light" value="{{ old('name') }}">
                </div>
                <div class="mb-3 col-lg-7 wow animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                    <input type="email" placeholder="Email" name="email" class="text-light" value="{{ old('email') }}">
                </div>
                <div class="mb-3 col-lg-7 wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                    <input type="tel" id="phone12" placeholder="Phone No." name="contact" class="text-light" value="{{ old('contact') }}">
                </div>
                <div class="mb-3 col-lg-7 wow animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                    <input type="text" placeholder="Reason for reaching out to us" name="message" class="text-light" value="{{ old('message') }}">
                </div>
