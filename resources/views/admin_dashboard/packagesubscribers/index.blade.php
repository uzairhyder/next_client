                                        ...
                                        @foreach ($subscribers as $value)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    ...
                                                    {{-- {{ ucwords(strtolower($value->get_user->name ?? null)) }} --}}
                                                    {{ ucwords(strtolower($value->get_user->first_name)) }} {{ ucwords(strtolower($value->get_user->last_name)) }}
                                                ...
                                                <td>
                                                    @if (is_object($value->get_user))
                                                        @if ($value->get_user->industry_id == null)
                                                            {{ $value->get_user->business_name ?? null }}
                                                        @else
                                                            {{ $value->get_user->industry->industry_type ?? null }}
                                                        @endif
                                                    @else
                                                        {{ null }} <!-- Handle the case when $value->get_user is not an object -->
                                                    @endif
                                                </td>
                                                ...
                                                {{-- <td>{{ date('j-M-Y H:i', strtotime($value->start_date)) ?? '' }}</td> --}}
                                                <td>{{ date('j-M-Y g:i A', strtotime($value->start_date)) ?? '' }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('subscriber-view', $value->id) }}"> <button
