                                    ...
                                    <?php if($editreview->customer_pay_time): ?>
                                        ...
                                        <div class="col-lg-1">
                                            <div class="form-check mb-4 radio-css" data-wow-duration="1s"
                                                data-wow-delay="0.5s">
                                                <p>
                                                    <input required type="radio" id="customer_payment_timetest1" value=" <?php echo e($editreview->uncheck_customer_pay_time_1); ?>"
                                                        name="customer_payment_time"
                                                       >
                                    ...
                                    <?php if($editreview->customer_recommendation): ?>
                                        ...
                                        <div class="col-lg-1">
                                            <div class="form-check mb-4 radio-css" data-wow-duration="1s"
                                                data-wow-delay="0.5s">
                                                <p>
                                                    <input required type="radio" id="customer_recommendationds" value="<?php echo e($editreview->customer_recommendation); ?>"
...
<?php echo $__env->make('admin_dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tuo1yqxe1xkd/public_html/live_project/project.conceptionmasters.com/next_client_dev/v2/resources/views/admin_dashboard/reviews/edit.blade.php ENDPATH**/ ?>