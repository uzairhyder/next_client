        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-lg-6 col-sm-12 wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                <div class="text-div">
                    ...
                    <h1>{{ $search_data->title1 ?? '' }} <span>
                           {{$search_data->title2 ?? ''}} <br>{{$search_data->title3 ?? ''}}</span>
                    </h1>
                    {{-- <div class="text-div point"> --}}
                        {!! $search_data->description ?? '' !!}
                            {{-- <p>*Only Information matching your search criteria will be displayed.
                               We do not publish address, email or phone numbers
                               <br>
                               Search our database based on name, email, phone and address.
                               <br>
                               Only searches that result in customers with reviews count against your available searches.
                               </p> --}}
                    {{-- </div> --}}
                </div>
            </div>
            <div class="col-lg-6 col-sm-12 pt-5">
                <div class="inner-img wow animated bounceIn" data-wow-duration="1s" data-wow-delay="0.5s">
                    <div class="innerDiv position-relative">
                        <img src="{{ url('public/banner',$search_data->banner_image) }}" alt="">
 ...
 <section class="sectionCstm">
     <div class="container">
        <div id="searchloader" class="loader"></div>
         ...
         <form method="post" action="{{ route('search-customers') }}" class="form" id="searchdataform">
            @csrf
             <div class="row d-flex justify-content-center align-items-center">
