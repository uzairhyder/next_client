...
@section('content')
                ...
                <div class="card tabsBox" id="tabs_id">
                    <ul class="nav nested nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active productaddvalidation" id="pillsProductTab" data-bs-toggle="pill"
                                data-bs-target="#pillsProduct" type="button" role="tab" aria-controls="pillsProductTab"
                                aria-selected="true">Product</button>
                        </li>
                        <li class="nav-item" role="presentation" id="checkvalidation">
                            <button class="nav-link button" id="pillsVariationTab" data-bs-toggle="pill"
                                data-bs-target="#pillsVariation" type="button" role="tab"
                                aria-controls="pillsVariationTab" aria-selected="false"
                                >Variations</button>
                        </li>
                    ...
                    <form id="product" class="myform" enctype="multipart/form-data" class="product_val">
    ...
    @push('scripts')
                    ...
                    $.ajax({
                        ...
                        success: function(response, data) {
                            ...
                            $.each(response.get_products_attributes, function(value, i) {
                                ...
                                var multiple_image_id = $("#multiple_image_id").val(i
                                    .product_id);
        ...
        <script>
            ...
            //     $("button[data-bs-target$='#pillsVariation']").click(function(){
            //         if($("input[value='']").length > 0){
            //     return false;
            //     }
            // });

            // $(".checktabs").on('click',function(){
            //     // alert('test');
            //     if($("#product_name").val() == ''){
            //         document.getElementById("pillsVariationTab").disabled = true;
