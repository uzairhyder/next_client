        ...
        <div class="row d-flex justify-content-center align-items-center">
            ...
            <form  id="forgetpassword" class="signForm">
                ...
                <div class="mb-3 col-lg-10 mx-auto col-sm-12 d-flex justify-content-center align-items-center wow animated fadeInRight" data-wow-duration="1s" data-wow-delay="0.5s">
                    ...
                    {{-- <span class="eyeicon for-smal-font resendButton"><a>Send</a></span> --}}
                     <div class="counterNumber">
                         {{-- <span id="cd-seconds" style="display:none;">00</span> --}}
                     </div>
                </div>
                {{-- <div class="d-flex justify-content-end col-lg-9 col-md-9">
                    <p class="wow animated bounceIn" data-wow-duration="1s" data-wow-delay="0.5s"><a href="{{ route('updatepassword') }}">Change Password</a></p>
                </div> --}}
        ...
        jQuery(document).ready(function() {
            $('.resendButton').on('click', function() {
                ...
                $.ajax({
                    ...
                    , type: "GET"
                    , url: "{{ route('verify-email-register') }}"
                    , data: {
                        'email': email
                    },
