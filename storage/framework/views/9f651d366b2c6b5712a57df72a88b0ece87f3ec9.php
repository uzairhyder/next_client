                        ...
                        <div class="table-responsive product-table">
                            <table class="display" id="basic-1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <th>Postal code</th>
                                        <td><?php echo e($detail->postal_code ?? ''); ?></td>
                                    </tr>
                                    <tr>
                                        <th>Business Name</th>
                                        <td><?php echo e($detail->industry->industry_type ?? ''); ?></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(!empty($detail->business_license_copy)): ?>
                                                <img src="<?php echo e(url('public/business_licenses/' . $detail->business_license_copy)); ?>"
