...
<script>
    ...
    paypal.Buttons({
        ...
        onApprove: function(data, actions) {
            ...
            $.ajax({
                url: "<?php echo e(route('subcription_updatepaypal_payment')); ?>",
                type: 'GET',
                data: data,
                success: function(data) {
                    ...
                    if (data.status == 200) {
                        // console.log(data)
                        // toastr.success('You have successfully purchased the plan', 'success');
                        // location.href = "<?php echo e(route('purchased-package')); ?>";
                        ...
                        // toastr.success('Something went wrong!, Please try again', 'success');
                        // location.href = "<?php echo e(route('purchased-package')); ?>";
                        swal({
                            title: "Dear User!",
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tuo1yqxe1xkd/public_html/live_project/project.conceptionmasters.com/next_client_dev/v1/resources/views/user_dashboard/payment.blade.php ENDPATH**/ ?>