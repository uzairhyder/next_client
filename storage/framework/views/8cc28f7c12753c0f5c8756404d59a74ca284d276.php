                ...
                <th style="text-align:center;">
                    ...
                    <tr>
                        ...
                        <button style="border-radius: 20px;padding: 10px 30px;border: none;background-color: #fff;font-family: 'Gilroy-Bold';font-weight: bold;color: #0071BC;border: 2px solid #003D70;cursor: pointer;font-size: 16px;">
                            <a href="<?php echo e(url('updatepassword/'.$token)); ?>" style="text-decoration: none;color: #0071BC;">Reset Your Password</a>
                        </button>
                    </th>
                    </tr>
...
<?php /**PATH /home/tuo1yqxe1xkd/public_html/live_project/project.conceptionmasters.com/next_client_dev/v1/resources/views/frontend/emails/reset_mail.blade.php ENDPATH**/ ?>