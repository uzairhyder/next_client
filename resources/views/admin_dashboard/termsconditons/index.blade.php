                ...
                <div class="card">
                    <div class="card-header">
                        {{-- <div class="col-xl-12 p-0 left-btn"><a class="btn btn-gradient" data-bs-original-title="" title=""
                                href="{{ route('terms-conditions.create') }}">Create</a></div> --}}
                                    ...
                                    <tbody>
                                        @foreach ($terms as $value)
                                            <tr role="row" class="odd">
                                                ...
                                                <td>
                                                    {{-- <a href="javascript:void(0);" class="deleteterms"
                                                        data-id="{{ $value->id }}">
                                                        <button class="btn btn-danger btn-xs" type="submit"
                                                            data-original-title="btn btn-danger btn-xs">Delete</button></a> --}}

                                                    <a href="{{ route('terms-conditions.edit', $value->id) }}"> <button
        ...
        <script>
            $(document).ready(function() {
                ...
                $(".deleteterms").on("click", function() {
                    ...
                    $.ajax({
                        url: "{{route('terms-conditions.destroy',"id")}}",
                        data: {
                            "id": id,
                            "_token": "{{ csrf_token() }}"
                        },
