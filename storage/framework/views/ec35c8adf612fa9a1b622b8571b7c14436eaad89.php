                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form theme-form">
                            ...
                            <form method="POST" action="<?php echo e(route('store-customer-review')); ?>" class="form-group" onsubmit="return ratingValidation()">
                                <?php echo csrf_field(); ?>
                                <div class="row">
...
<?php echo $__env->make('admin_dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tuo1yqxe1xkd/public_html/live_project/project.conceptionmasters.com/next_client_dev/v2/resources/views/admin_dashboard/reviews/add.blade.php ENDPATH**/ ?>