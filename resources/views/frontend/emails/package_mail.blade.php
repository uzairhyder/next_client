...
<body>
    <table style="height:100%;width:50%;margin-left:auto;margin-right: auto; background-image: linear-gradient(to right bottom, #8de1f8 50%, #fff 50.3%); border: 1px solid #cfcfcf;">
        ...
        <tbody>
            ...
            <tr>
                  <th>
                     <p style="font-family: Gilroy-Bold;color: #0071BC;text-align: start; margin-left: 30px;font-size: 16px;">Package Name : <span>{{ $data['package_name'] }}</span></p>
            ...
            <tr>
                <th>
                    <p style="font-family: Gilroy-Bold;color: #0071BC;text-align: start;
                        margin-left: 30px;font-size: 16px;">Starting Date : <span>{{ $data['start_date'] }}</span></p>
            ...
            <tr>
                <th>
                    <p style="font-family: Gilroy-Bold;color: #0071BC;text-align: start;
                        margin-left: 30px;font-size: 16px;">Ending Date : <span>{{ $data['end_date'] }}</span></p>
                </th>
            </tr>
            ...
            <tr>
                 <th>
                        <p style="font-family: Gilroy-Bold;color: #0071BC;text-align: start;
                            margin-left: 30px;font-size: 16px;">Package Price : <span>${{ $data['package_price'] }}</span> </p>
                </th>
            </tr>
            <tr>
                <th>
             ...
             <tr>
                 <th>
                     <p style="font-family: Gilroy-Bold;color: #0071BC;text-align: start;
                            margin-left: 30px;font-size: 16px;">Package Description : <span> {{strip_tags($data['package_description']) }}</span></p>
                 </th>
             </tr>
