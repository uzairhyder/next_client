                ...
                <div class="row">
                    ...
                    <div class="d-flex justify-content-end align-items-center col-lg-12 accept  wow animated fadeInLeft" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <p>
                            ...
                            <label for="test7"><a href="<?php echo e(route('terms.and.conditions')); ?>" style="text-decoration: none;">Accept Term & Condition</a></label>
                        </p>
                    </div>
...
<?php echo $__env->make('frontend.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tuo1yqxe1xkd/public_html/live_project/project.conceptionmasters.com/next_client_dev/v1/resources/views/frontend/review.blade.php ENDPATH**/ ?>