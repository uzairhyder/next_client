                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select id="parent_category_id" name="parent_category_id"
                                                    ...
                                                    @foreach ($parent_categories as $parents)
                                                        <option id="parent_category_id" value="{{ $parents->id }}" {{$parents->id == $products->parent_category_id ? 'selected' : ''}}
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" id="product_name" type="text"
                                                    placeholder="Enter Product Title" data-bs-original-title="" value="{{$products->product_name}}"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                                ...
                                                <input class="form-control" type="number" id="total_price"
                                                    placeholder="Enter Product Price" data-bs-original-title=""
                                                    title="" name="total_price"  value="{{$products->total_price}}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-3">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control editor" name="short_description" id="short_description" cols="30"
                                                    rows="10">{!!$products->short_description!!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="container">
                                    <div class="rows">
                                        <div class="row">
                                            ...
                                            <input type="hidden" id="edit_data" name="edit_data" value="{{$products->id}}">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="attribute_value" id="attribute_value"
                                                            class="form-control for-height-input" value="{{$value->attribute_value}}">
                                    ...
                                    <form id="multiple_tags">
                                        ...
                                        <div class="mb-3" id="tags_name">
                                            ...
                                            <input type="text" name="tags_value" class="form-control" id="tags_value"
                                                placeholder="Enter Tags" value="{{$products->tags}}">
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    {{-- <a href="{{route('product.index')}}">
                                        <div>
                                            <button class="startUploadButton smallButton">Go Back</button>
                                        </div>
                                    </a> --}}
                                </div>
                            </div>
            ...
            success: function(response) {
                ...
                if (response != '') {
                    $.each(response.subcategory, function(value, i) {
                        var select = ('{{$products->id}}' == i.sub_category_name ? 'selected="selected"' : '');
                        // console.log(i.sub_category_namee);
                    ...
                    $.ajax({
                        ...
                        success: function(response, data) {
                            ...
                            $.each(response.get_products_attributes, function(value, i) {
                                var id = $("#tag_id").val(i.product_id);
                                var multiple_image_id = $("#multiple_image_id").val(i.product_id);
                                var main_image_id = $("#main_image_id").val(i.product_id);
                                $('#stock').append(
                                    `
                                        ...
                                        <input class="form-control" name="attribute_value" type="text" value="${i.attribute_value}"
                                            ...
                                            <input class="form-control" id="stock_value" name="stock[]" value="${i.stock}" type="text"
